const TOOLS = {"sku-generator": {"title": "SKU Generator", "desc": "Generate readable SKU codes from brand, category, color, size, and number.", "category": "Listings", "kind": "sku", "fields": [{"id": "brand", "label": "Brand", "type": "text", "value": "BMH"}, {"id": "category", "label": "Category", "type": "text", "value": "TEE"}, {"id": "color", "label": "Color", "type": "text", "value": "BLACK"}, {"id": "size", "label": "Size", "type": "text", "value": "M"}, {"id": "number", "label": "Number", "type": "number", "value": 1001}], "manual": false}, "listing-title-checker": {"title": "Listing Title Checker", "desc": "Check listing title length, word count, and keyword placement.", "category": "Listings", "kind": "listingTitle", "fields": [{"id": "title", "label": "Listing title", "type": "text", "value": "Men's Lightweight Running Shoes Breathable Sneakers Black Size 10"}, {"id": "keyword", "label": "Primary keyword", "type": "text", "value": "running shoes"}], "manual": false}, "dimensional-weight-calculator": {"title": "Dimensional Weight Calculator", "desc": "Estimate dimensional weight for shipping packages.", "category": "Shipping", "kind": "dimWeight", "fields": [{"id": "length", "label": "Length in", "type": "number", "value": 12}, {"id": "width", "label": "Width in", "type": "number", "value": 10}, {"id": "height", "label": "Height in", "type": "number", "value": 8}, {"id": "divisor", "label": "Carrier divisor", "type": "number", "value": 139}], "manual": false}, "inventory-reorder-calculator": {"title": "Inventory Reorder Calculator", "desc": "Calculate reorder point from demand, lead time, and safety stock.", "category": "Inventory", "kind": "reorder", "fields": [{"id": "daily", "label": "Daily sales", "type": "number", "value": 12}, {"id": "lead", "label": "Lead time days", "type": "number", "value": 14}, {"id": "safety", "label": "Safety stock", "type": "number", "value": 50}], "manual": false}, "stock-cover-calculator": {"title": "Stock Cover Calculator", "desc": "Estimate how many days current inventory will last.", "category": "Inventory", "kind": "stockCover", "fields": [{"id": "stock", "label": "Current stock", "type": "number", "value": 500}, {"id": "daily", "label": "Daily sales", "type": "number", "value": 20}], "manual": false}, "return-rate-calculator": {"title": "Return Rate Calculator", "desc": "Calculate return rate and net kept orders.", "category": "Profit", "kind": "returnRate", "fields": [{"id": "orders", "label": "Orders", "type": "number", "value": 1000}, {"id": "returns", "label": "Returns", "type": "number", "value": 45}], "manual": false}, "discount-margin-calculator": {"title": "Discount Margin Calculator", "desc": "See how discounts affect profit margin.", "category": "Profit", "kind": "discountMargin", "fields": [{"id": "price", "label": "Regular price", "type": "number", "value": 100}, {"id": "cost", "label": "Unit cost", "type": "number", "value": 45}, {"id": "discount", "label": "Discount %", "type": "number", "value": 20}], "manual": false}, "bundle-price-calculator": {"title": "Bundle Price Calculator", "desc": "Calculate bundle price, savings, and margin.", "category": "Profit", "kind": "bundle", "fields": [{"id": "items", "label": "Separate item total", "type": "number", "value": 120}, {"id": "bundle", "label": "Bundle price", "type": "number", "value": 99}, {"id": "cost", "label": "Total cost", "type": "number", "value": 55}], "manual": false}, "aov-calculator": {"title": "Average Order Value Calculator", "desc": "Calculate average order value from revenue and orders.", "category": "Profit", "kind": "aov", "fields": [{"id": "revenue", "label": "Revenue", "type": "number", "value": 25000}, {"id": "orders", "label": "Orders", "type": "number", "value": 420}], "manual": false}, "roas-calculator": {"title": "ROAS Calculator", "desc": "Calculate return on ad spend and break-even ROAS.", "category": "Profit", "kind": "roas", "fields": [{"id": "revenue", "label": "Ad revenue", "type": "number", "value": 5000}, {"id": "ad", "label": "Ad spend", "type": "number", "value": 1000}, {"id": "margin", "label": "Gross margin %", "type": "number", "value": 35}], "manual": false}, "shipping-cost-per-unit": {"title": "Shipping Cost Per Unit Calculator", "desc": "Allocate shipping cost across units.", "category": "Shipping", "kind": "shipUnit", "fields": [{"id": "shipping", "label": "Shipment cost", "type": "number", "value": 240}, {"id": "units", "label": "Units", "type": "number", "value": 120}], "manual": false}, "etsy-tag-length-checker": {"title": "Marketplace Tag Length Checker", "desc": "Check tag count, character length, and duplicate tags.", "category": "Listings", "kind": "tags", "fields": [{"id": "tags", "label": "Tags, comma separated", "type": "textarea", "value": "gift, handmade gift, wall art, printable art, gift"}], "manual": false}, "amazon-title-checker": {"title": "Amazon Listing Title Checker", "desc": "Check marketplace title length, word count, and primary keyword placement.", "category": "Listings", "kind": "listingTitle", "fields": [{"id": "title", "label": "Listing title", "type": "text", "value": "Stainless Steel Water Bottle Insulated 32 oz Leakproof Black"}, {"id": "keyword", "label": "Primary keyword", "type": "text", "value": "water bottle"}], "manual": false}, "shopify-sku-generator": {"title": "Shopify SKU Generator", "desc": "Generate readable SKU codes for Shopify products and variants.", "category": "Listings", "kind": "sku", "fields": [{"id": "brand", "label": "Brand", "type": "text", "value": "SHOP"}, {"id": "category", "label": "Category", "type": "text", "value": "BAG"}, {"id": "color", "label": "Color", "type": "text", "value": "NAVY"}, {"id": "size", "label": "Size", "type": "text", "value": "OS"}, {"id": "number", "label": "Number", "type": "number", "value": 2048}], "manual": false}, "amazon-fba-dim-weight-calculator": {"title": "Amazon FBA Dimensional Weight Calculator", "desc": "Estimate dimensional weight for cartons, packages, and FBA planning.", "category": "Shipping", "kind": "dimWeight", "fields": [{"id": "length", "label": "Length in", "type": "number", "value": 16}, {"id": "width", "label": "Width in", "type": "number", "value": 12}, {"id": "height", "label": "Height in", "type": "number", "value": 10}, {"id": "divisor", "label": "Carrier divisor", "type": "number", "value": 139}], "manual": false}, "inventory-days-cover-calculator": {"title": "Inventory Days Cover Calculator", "desc": "Estimate how many days current inventory will last at the current sales rate.", "category": "Inventory", "kind": "stockCover", "fields": [{"id": "stock", "label": "Current stock", "type": "number", "value": 850}, {"id": "daily", "label": "Daily sales", "type": "number", "value": 34}], "manual": false}, "reorder-point-planner": {"title": "Reorder Point Planner", "desc": "Calculate reorder point from daily sales, supplier lead time, and safety stock.", "category": "Inventory", "kind": "reorder", "fields": [{"id": "daily", "label": "Daily sales", "type": "number", "value": 18}, {"id": "lead", "label": "Lead time days", "type": "number", "value": 21}, {"id": "safety", "label": "Safety stock", "type": "number", "value": 80}], "manual": false}, "return-impact-calculator": {"title": "Return Impact Calculator", "desc": "Calculate return rate and kept orders after returns.", "category": "Profit", "kind": "returnRate", "fields": [{"id": "orders", "label": "Orders", "type": "number", "value": 2500}, {"id": "returns", "label": "Returns", "type": "number", "value": 125}], "manual": false}, "promo-discount-margin-calculator": {"title": "Promo Discount Margin Calculator", "desc": "See how a discount changes sale price, profit, and margin.", "category": "Profit", "kind": "discountMargin", "fields": [{"id": "price", "label": "Regular price", "type": "number", "value": 59}, {"id": "cost", "label": "Unit cost", "type": "number", "value": 21}, {"id": "discount", "label": "Discount %", "type": "number", "value": 15}], "manual": false}, "ad-break-even-roas-calculator": {"title": "Ad Break Even ROAS Calculator", "desc": "Calculate ROAS and break-even ROAS from ad revenue, spend, and margin.", "category": "Profit", "kind": "roas", "fields": [{"id": "revenue", "label": "Ad revenue", "type": "number", "value": 12000}, {"id": "ad", "label": "Ad spend", "type": "number", "value": 2800}, {"id": "margin", "label": "Gross margin %", "type": "number", "value": 42}], "manual": false}};
